...
function updateVisualization(index) {
  ...
  document.querySelector(".overlay").style.backgroundColor =
    colorScale(overallStress);

  // Update stress stats dynamically
  document.getElementById("heart-rate-value").textContent =
    stressLevels2.hr.toFixed(2);
  document.getElementById("bvp-value").textContent =
    stressLevels2.bvp.toFixed(2);
  document.getElementById("temperature-value").textContent =
    stressLevels2.temp.toFixed(2);
  document.getElementById("eda-value").textContent =
    stressLevels2.eda.toFixed(2);
}
